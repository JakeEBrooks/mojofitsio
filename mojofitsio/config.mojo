struct config:
    ...
    alias END_kw_str = "END     " # 8 byte keyword entry containing END in bytes 0-2
    alias END_kw_simd = SIMD[DType.int8, 8](69, 78, 68, 32, 32, 32, 32, 32) # END_line_str as a SIMD of bytes